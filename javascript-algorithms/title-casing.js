//title-casing
/* TASK:
  This function should return the input string but with adherence to APA style
  for title casing. Capitalize the first word of any title and subtitle, all
  nouns, verbs, adjectives, adverbs, and pronouns, including hyphenated words,
...
function titleCase(title) {
  ...
  for (var i = 0; i < wordsArr.length; i++) {
    ...
    if (pos > 0) {
      ...
      // checks second word and capitalizes first letter, then slices all letters after hyphen.
...
let caseMe = "here and back Again: a hobbit's Tale"

console.log('string to be title cased:', caseMe)
console.log('string title cased:', titleCase(caseMe))
