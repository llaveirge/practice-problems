//card-game
/* TASK:
  This function should determine the winner of a card game based on the sum of
  each players cards.

  input: an array and a number, output: winner's name

  Pseudo code:
  Create an empty array to store a deck of 52 cards.
  Iterate through 4 suits and 13 ranks to create a card deck and store each
  card in 'cardDeck'.
  Shuffle the deck and stor3 the shuffled deck in a variable
  Move the appropriate number of cards, defined by 'numberOfCards' parameter
  from the beginning of 'shuffledDeck' to each player's hand
  ...
  Sum up each player's score and assign the value to a score property of each
  player object
